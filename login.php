	...
	<div class="container">
	    <div class="row">
	        <div class="col-sm-6 col-md-4 col-md-offset-4">
	            <h1 class="text-center login-title">Penerimaan Siswa Baru SLB Karya Bhakti</h1>
	            <div class="account-wall">
	              <div style="text-align: center;">
					  <img src="33.jpg" width="100" height="100" alt="Logo" style="display: inline-block;">
					</div>
	                ...
	                <form class="form-signin" method="post" action="">
		                ...
		                <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">
		                    Sign in</button>
		                    <div class="container">
		                    	<td><h7> <a href=""></a>Email :slbkaryabhaktibandung@gmail.com</h7></td>
	    	<br>
	    <td><h7> <a href=""></a>Kontak Person :0227215311</h7></td>
		                    </div>
