...
<div class="row">
 ...
 <div class="card-content">
                <div class="btn-group" role="group" aria-label="Class Selection">
                    <button type="button" class="btn btn-primary" onclick="loadJadwal('A')">Kelas A</button>
                    <button type="button" class="btn btn-primary" onclick="loadJadwal('B')">Kelas B</button>
                    <button type="button" class="btn btn-primary" onclick="loadJadwal('C')">Kelas C</button>
                </div>
            </div>
            <div class="card-content">
