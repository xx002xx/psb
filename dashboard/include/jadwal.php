...
?>
<a href="index.php?page=23&kelas=B" class="btn btn-primary pull-right btn-md" style="margin-right: 80px"><i class="fa fa-plus"></i> Input jadwal Kelas A</a>
...
<a href="index.php?page=23&kelas=B" class="btn btn-primary pull-right btn-md" style="margin-right: 80px"><i class="fa fa-plus"></i> Input jadwal Kelas C</a>
