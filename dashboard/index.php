...
<body>
   ...
   <div class="wrapper" style="background-image: url('123.PNG') ;">
            ...
            <ul class="nav">
               ...
               <li class="<?php $_SESSION['active'] == 3 ? print("active") : print("") ?>">
                  <a href="index.php?page=4">
                     <i class="material-icons">content_paste</i>
                     <p>Syarat Pendaftaran & Pembayaran</p>
                  </a>
               </li>
...
document.getElementById('link_xxxxx').addEventListener('click', function() {
   // Ubah nilai atribut href saat elemen diklik
   this.href = 'include/informasipendidikan.php';

   // Jika Anda ingin membuka link setelah mengubah atribut href
